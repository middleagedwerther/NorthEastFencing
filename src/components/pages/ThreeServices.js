...
const Cell = styled.div`
  ...
  &:hover {
    border-color: ${props => props.primaryColour}; /* Change this color to whatever you prefer */
  }
`;
...
const SectionHeading = styled.div`
  ...
  padding: 10px;
  font-size: 30px;
  color: ${props => props.secondaryColour}; // Updated to use secondaryColour
  margin-bottom: 0;
  font-family: ${props => props.globalFont};
`;
...
export default function ThreeServices() {
  ...
  return (
    <>
      <SectionHeading globalFont={GlobalFont} secondaryColour={SecondaryColour}>Our Services</SectionHeading>
      ...
      <Container globalFont={GlobalFont}>
        <Cell primaryColour={PrimaryColour}>
          ...
          <>
            <SubHeading globalFont={GlobalFont} secondaryColour={SecondaryColour}>Wood</SubHeading>
        ...
        <Cell primaryColour={PrimaryColour}>
          ...
          <>
            <SubHeading globalFont={GlobalFont} secondaryColour={SecondaryColour}>Aluminium</SubHeading>
        ...
        <Cell primaryColour={PrimaryColour}>
          ...
          <>
            <SubHeading globalFont={GlobalFont} secondaryColour={SecondaryColour}>Iron</SubHeading>
